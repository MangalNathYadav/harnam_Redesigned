                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div>
                        ...
                        <p className="text-gray-700 leading-relaxed mb-10 text-lg md:text-xl font-medium opacity-90">
                            Founded in 2025, our journey began in a small spice shop in the heart of the markets. What started as a passion project evolving into a legacy of trust and flavor that spans generations.
                        </p>
                        ...
                        <div className="flex items-center gap-5 bg-white shadow-xl p-4 md:p-5 rounded-[2rem] border border-zinc-50 w-full sm:w-fit">
                            <div className="w-16 h-16 flex-shrink-0 rounded-full overflow-hidden border-2 border-secondary/20 p-1">
                            ...
                            <div className="min-w-0">
                                ...
                                <div className="text-xl font-black text-gray-900 truncate sm:whitespace-nowrap">Shri Harnam Singh</div>
                            </div>
                        </div>
                    </div>
